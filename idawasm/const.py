...
WASM_OPCODE_DESCRIPTIONS = {
    ...
    wasm.OP_F32_CONST: 'produce the value of an f32 immediate',
    ...
    wasm.OP_F64_CONST: 'produce the value of an f64 immediate',
    ...
    wasm.OP_I32_CONST: 'produce the value of an i32 immediate',
    ...
    wasm.OP_I64_CONST: 'produce the value of an i64 immediate',
